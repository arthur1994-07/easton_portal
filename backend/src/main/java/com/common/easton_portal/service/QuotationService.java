...
public class QuotationService {
    ...
    public void create(String quoteNum, String assignee, String base64Profile, long requestId) throws Exception {
        ...
        var quotationEntity = QuotationEntity.builder().quoteNum(quoteNum).assignee(assignee).document(LobHelper.toLob(data))
                .build();
